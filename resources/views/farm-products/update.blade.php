...
@section('header')
    <div class="create-product-header">
        <div class="header-navigation">
            <a href="{{ route('farm-products.show', $product->id) }}" class="back-btn">
        ...
        <div class="header-content">
            ...
            <p class="page-subtitle" style="color: white">Update your product information and settings</p>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="create-product-container">
        ...
        <div class="changes-indicator" id="changesIndicator">
            ...
            <span>You have unsaved changes. Remember to save your updates.</span>
        </div>

        <div class="form-container fade-in">
            <form id="productForm" method="POST" action="{{ route('farm-products.update', $product->id) }}"
                    ...
                    <div class="form-section">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name"
                                    ...
                                    value="{{ old('name', $product->name) }}" placeholder="e.g., Fresh Organic Tomatoes"
                                    required />
                                @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="unit_of_measurement" name="unit_of_measurement"
                                        ...
                                        <option value="dozen"
                                            ...
                                            Dozen</option>
                                        <option value="piece"
                                            {{ old('unit_of_measurement', $product->unit_of_measurement) == 'piece' ? 'selected' : '' }}>
                                            Piece</option>
                                        <option value="bundle"
                                            {{ old('unit_of_measurement', $product->unit_of_measurement) == 'bundle' ? 'selected' : '' }}>
                                            Bundle</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" class="form-textarea {{ $errors->has('description') ? 'error' : '' }}"
                                    placeholder="Describe your product in detail - quality, freshness, farming methods, etc." required>{{ old('description', $product->description) }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tags" name="tags"
                                    ...
                                    placeholder="organic, fresh, local, pesticide-free" />
                                @if ($errors->has('tags'))
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i>
                                        {{ $errors->first('tags') }}
                        ...
                        {{-- <div class="status-section">
                            ...
                            <div class="status-toggle">
                                <span>Toggle to change product status</span>
                                <div class="toggle-switch" id="statusToggle" data-status="{{ $product->status }}">
                    ...
                    <div class="image-upload-section">
                        ...
                        <div class="image-preview-wrapper">
                            @if ($product->product_image)
                                <img id="preview-image" src="{{ asset('product_images/' . $product->product_image) }}"
                                    alt="Preview" class="preview-image" />
                            @else
                                <img id="preview-image" src="" alt="Preview" class="preview-image" />
                            @endif
                            <div class="preview-placeholder" id="preview-placeholder"
                                @if ($product->product_image) style="display: none;" @endif>
    ...
    <div class="modal" id="confirmModal"
        ...
        <div style="background: white; border-radius: 16px; padding: 30px; max-width: 400px; text-align: center;">
            ...
            <h3 style="color: #c62828; margin-bottom: 15px;">Delete Product</h3>
            <p style="color: #666; margin-bottom: 25px;">Are you sure you want to delete this product? This action cannot
                be undone.</p>
            <div style="display: flex; gap: 10px; justify-content: center;">
    ...
    <script>
        ...
        function initializeForm() {
            ...
            statusToggle.addEventListener('click', function() {
                ...
                this.classList.toggle('published');
                this.querySelector('.toggle-slider').style.transform = newStatus === 'published' ?
                    'translateX(30px)' :
                    'translateX(0)';
            });
            ...
            document.querySelectorAll('input, select, textarea').forEach(element => {
                element.addEventListener('input', showChangesIndicator);
                element.addEventListener('change', showChangesIndicator);
            });
        }
        ...
        function deleteProduct() {
            ...
            fetch(`/farm-products/${currentProductId}`, {
                    method: 'DELETE',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        setTimeout(() => window.location.href = '{{ route('farm-products.index') }}', 1500);
                    } else {
        ...
        function showNotification(message, type = 'info') {
            ...
            notification.innerHTML = `
                <div style="padding: 15px 20px; display: flex; align-items: center; gap: 12px;">
                    ...
                    <span>${message}</span>
                    <button onclick="this.parentElement.parentElement.remove()" style="background: none; border: none; color: #666; cursor: pointer; margin-left: auto; padding: 5px;">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
            `;
